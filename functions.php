...
{
    register_nav_menu( 'left_menu', __( 'Left Menu', 'sunningdale' ) );
    register_nav_menu( 'right_menu', __( 'Right Menu', 'sunningdale' ) );
}
new StarterSite();

add_filter( 'timber_context', 'sunningdale_timber_context'  );

function sunningdale_timber_context( $context ) {
    $context['options'] = get_fields('options');
